...
"""Generate Rust and Python service enums from defs/bloomberg.toml."""
...
RUST_HEADER = "// @generated by codegen/generate.py from defs/bloomberg.toml — DO NOT EDIT"
PY_HEADER = "# @generated by codegen/generate.py from defs/bloomberg.toml — DO NOT EDIT"
...
def render_rust(defs: dict[str, Any]) -> str:
    ...
    lines.append("///")
    lines.append("/// Standard Bloomberg API services with URIs from the Bloomberg C++ SDK.")
    ...
    lines.append("        Ok(Self::from_str(&s).unwrap()) // Infallible")
    lines.append("    }")
    lines.append("}")
    lines.append("")
    lines.append("/// Bloomberg request operation names.")
    lines.append("///")
    lines.append("/// Standard Bloomberg API operation types from the Bloomberg C++ SDK.")
