...
class ArrowSchema:
    ...
    @property
    def fields(self) -> builtins.list[ArrowField]: ...
...
class ArrowColumn:
    ...
    def name(self) -> builtins.str: ...
    @property
    def field(self) -> ArrowField: ...
    @property
    def data_type(self) -> builtins.str: ...
    @property
    def null_count(self) -> builtins.int: ...
    @property
    def nbytes(self) -> builtins.int: ...
    def slice(self, offset: builtins.int = 0, length: builtins.int | None = None) -> ArrowColumn: ...
...
class ArrowRecordBatch:
    ...
    def __arrow_c_array__(self, requested_schema: typing.Any = None) -> typing.Any: ...
    def __arrow_c_schema__(self) -> typing.Any: ...
    def to_pylist(self) -> builtins.list[dict[builtins.str, typing.Any]]: ...
    def to_table(self) -> ArrowTable: ...
    def to_pyarrow(self) -> typing.Any: ...
    def column(self, column: builtins.int | builtins.str) -> ArrowColumn: ...
    def get_column(self, column: builtins.int | builtins.str) -> ArrowColumn: ...
    def __getitem__(self, column: builtins.int | builtins.str) -> ArrowColumn: ...
    def select(self, columns: typing.Sequence[builtins.int | builtins.str]) -> ArrowRecordBatch: ...
    def slice(self, offset: builtins.int = 0, length: builtins.int | None = None) -> ArrowRecordBatch: ...
    def __len__(self) -> builtins.int: ...
    def __repr__(self) -> builtins.str: ...
...
class ArrowTable:
    @classmethod
    def from_pylist(cls, rows: typing.Iterable[dict[builtins.str, typing.Any]], schema: typing.Any = None) -> ArrowTable: ...
    @classmethod
    def empty(cls, schema_or_columns: typing.Sequence[builtins.str] | ArrowSchema) -> ArrowTable: ...
    @classmethod
    def from_batches(cls, batches: typing.Iterable[ArrowRecordBatch]) -> ArrowTable: ...
    @classmethod
    def concat_tables(cls, tables: typing.Iterable[ArrowTable]) -> ArrowTable: ...
    @property
    def column_names(self) -> builtins.list[builtins.str]: ...
    @property
    def num_rows(self) -> builtins.int: ...
    ...
    def __getitem__(self, column: builtins.int | builtins.str) -> ArrowColumn: ...
    @typing.overload
    def __getitem__(self, columns: typing.Sequence[builtins.int | builtins.str]) -> ArrowTable: ...
    def __len__(self) -> builtins.int: ...
    def select(self, columns: typing.Sequence[builtins.int | builtins.str]) -> ArrowTable: ...
    ...
    def slice(self, offset: builtins.int = 0, length: builtins.int | None = None) -> ArrowTable: ...
    ...
    def add_column(self, index: builtins.int, name: builtins.str, values: typing.Sequence[typing.Any]) -> ArrowTable: ...
    def set_column(self, index: builtins.int, name: builtins.str, values: typing.Sequence[typing.Any]) -> ArrowTable: ...
    ...
    def apply_historical_presentation(
        self,
        show_date: builtins.bool | None,
        date_format: builtins.str | None,
        sort: builtins.str | None,
        periodicity: builtins.str | None,
    ) -> ArrowTable: ...
