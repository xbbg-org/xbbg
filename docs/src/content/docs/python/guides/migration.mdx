...
### Native datetime / date acceptance (1.x)
...
[Dates and Datetimes guide](../dates/) for the full reference.
...
xbbg 1.x accepts the 0.x Bloomberg request-element aliases before a request is sent to Bloomberg.
