...
- [Output Formats](/xbbg/guides/output-formats/) — control the shape of returned data (LONG, LONG_TYPED, etc.)
- [API Reference](/xbbg/api/blp/) — full function documentation with all parameters
