---
title: Changelog
description: Release notes synced from the repository root CHANGELOG.md
---

_This page is generated from the repository root [CHANGELOG.md](https://github.com/alpha-xone/xbbg/blob/main/CHANGELOG.md) during docs builds._
